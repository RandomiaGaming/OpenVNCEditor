...
namespace OpenVNC
{
    public static class MathHelper
    {
       ...
       public static double DotProduct(Vector a, Vector b)
        ...
        public static byte ColorLerp(byte sample, byte a, byte b)
        {
            return (byte)(a + ((b - a) * sample));
        }
        public static byte InverseColorLerp(byte sample, byte a, byte b)
        {
            return (byte)((sample - a) / (b - a));
        }
